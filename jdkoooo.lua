...
-- Uses CoinCollectedEvent for reset detection (most reliable).
-- Movement: fast tween-based (tested working).
-- ============================================================
...
AutoSection:Paragraph({
    Title = "📌 Reset Method",
    Desc = "Uses CoinCollectedEvent – no UI path needed, always accurate."
})
...
AutoSection:Toggle({
    ...
    Desc = "Kills you when you reach max coins (uses CoinCollectedEvent)",
    Value = false,
...
-- ============================================================
-- CORE ENGINE – MOVEMENT (working tween version)
-- ============================================================
...
-- ============================================================
-- COIN COLLECTED EVENT – RESET DETECTION
-- ============================================================
local CoinCollectedEvent = ReplicatedStorage:FindFirstChild("Remotes") and ReplicatedStorage.Remotes.Gameplay and ReplicatedStorage.Remotes.Gameplay:FindFirstChild("CoinCollected")
...
if CoinCollectedEvent then
    CoinCollectedEvent.OnClientEvent:Connect(function(cointype, current, max)
        ...
        maxCoins = max
        -- Debug print every time we get an event
        print(string.format("💰 Coin update: %d / %d", current, max))

        -- Reset condition
        if autoResetOnMax and current >= max and LocalPlayer.Character then
            print("🎯 RESET TRIGGERED via CoinCollected! Coins:", current, "Max:", max)
    ...
    print("⚠️ CoinCollectedEvent not found – reset will not work!")
end
...
-- ============================================================
-- MAIN HEARTBEAT – movement only (reset handled by event)
-- ============================================================
...
-- ============================================================
Window:Notify({
    Title = "Bunnyware V5 🐰 Lite (CoinCollected reset)",
    Content = "Loaded! Reset uses CoinCollectedEvent – no UI path needed.",
    Duration = 5,
})

print("✅ Bunnyware V5 Lite loaded with CoinCollectedEvent reset.")