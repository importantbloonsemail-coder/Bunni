...
-- Coin reading copied EXACTLY from Overdrive H.
-- ============================================================
...
AutoSection:Toggle({
    ...
    Desc = "Kills you when you reach max coins (uses Overdrive's coin reading)",
    Value = false,
...
-- ============================================================
-- CORE ENGINE – AUTOFARM (Overdrive style)
-- ============================================================
...
-- ============================================================
-- COIN READING – EXACTLY AS OVERDRIVE H
-- ============================================================
local u49 = nil  -- false = in game, true = in lobby

-- Determine if we're in game or lobby (copied from Overdrive)
local function determineGameOrLobby()
    ...
    if gui then
        ...
        if main then
            ...
            if gameUI then
                -- If Inventory exists, we are in a round -> u49 = false
...
-- ============================================================
-- HELPER FUNCTIONS (from Overdrive)
-- ============================================================
...
-- ============================================================
-- NOCLIP, BODYGYRO, BODYVELOCITY (Overdrive style)
-- ============================================================
...
-- ============================================================
-- MAIN HEARTBEAT – Overdrive style
-- ============================================================
RunService.Heartbeat:Connect(function()
    ...
    -- Coin reading using Overdrive's exact function
    local currentCoins = u65()
    local maxCoin = maxCoins
    if LocalPlayer:GetAttribute("Elite") then maxCoin = 50 end
    ...
    -- Reset condition (using >= for safety, but Overdrive uses ==)
    ...
    -- === FARMING LOGIC (unchanged – works fast) ===
...
LocalPlayer.CharacterAdded:Connect(function()
    task.wait(0.5)
    cleanupAutofarm()
    determineGameOrLobby()  -- refresh u49
end)

-- ============================================================
-- PERIODIC UI PATH REFRESH (like Overdrive)
-- ============================================================
coroutine.wrap(function()
    while true do
            ...
            if remote then
                ...
                if extras then
                    ...
                    if getPlayerData and getPlayerData:IsA("RemoteFunction") then
                        ...
                        if success and data then
                            local myData = data[LocalPlayer.Name]
                            u47 = myData and (not myData.Dead and not myData.Killed)
                        end
                    end
                end
            end
        ...
        -- Update map
        for _, v166 in next, workspace:GetChildren() do
...
-- ============================================================
Window:Notify({
    Title = "Bunnyware V5 🐰 Lite (Overdrive coin reading)",
    Content = "Loaded! Watch console for coin stats.",
    Duration = 5,
})

print("✅ Bunnyware V5 Lite with Overdrive's coin reading loaded.")