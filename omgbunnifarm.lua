...
-- Now using Overdrive's exact autofarm logic – no blocking, fast coins.
-- ============================================================
...
AutoSection:Toggle({
    ...
    Desc = "Kills you when you reach max coins",
    Value = false,
...
AutoSection:Button({
    ...
    Desc = "Triggers reset logic immediately – to test if reset works",
    Callback = function()
...
-- ============================================================
-- COIN READING – multiple methods (with debug)
-- ============================================================
...
-- ============================================================
-- MAIN HEARTBEAT – Overdrive style (non‑blocking)
-- ============================================================
        ...
        if v149 then
            ...
            if v150 then
                if v150 ~= u76 then
                    ...
                    u74 = true
                    if u75 then u75:Cancel() end
                    u67(true)  -- enable gyro/vel/noclip
                    local CFrame5 = v150.CFrame
                    local dist = u61(v149.Position, v150.Position)
                    local duration = dist * 0.04465  -- same as Overdrive
...
-- ============================================================
Window:Notify({
    Title = "Bunnyware V5 🐰 Lite (Overdrive engine)",
    Content = "Loaded! Watch console for coin stats.",
    Duration = 5,
})

print("✅ Bunnyware V5 Lite (Overdrive engine) loaded.")