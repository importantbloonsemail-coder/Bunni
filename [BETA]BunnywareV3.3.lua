...
-- NEW TOGGLE: Make all shoots silent (PC)
...
-- Function to perform silent shoot on left-click
...
UserInputService.InputBegan:Connect(function(input, processed)
    ...
    if silentAllShoots and input.UserInputType == Enum.UserInputType.MouseButton1 then
        performSilentShoot()
    end
end)
